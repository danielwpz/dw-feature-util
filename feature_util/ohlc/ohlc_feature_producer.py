class FeatureProducerOHLC:
    ...
    def produce(self, df):
        """
        Produce a new feature based on given OHLC dataframe.
...
class FeatureProducerOHLCPipeline(FeatureProducerOHLC):
    """
    This gives users the ability to combine several OHLC feature producers into a pipeline.
    One can create a list of solid producer instances and put them in the pipeline to construct
    a big new producer.
    """
    def __init__(self, producers):
        FeatureProducerOHLC.__init__(self, None)
